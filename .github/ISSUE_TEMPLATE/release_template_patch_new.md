...
- [ ] Read the documentation of `release --help` tool to understand what each
      automated step does.
...
- [ ] Go to [release workflow] and trigger the "2-prepare-release" step for vX.Y.Z
...
- [ ] Go to [release workflow] and trigger the "4-prepare-release" step for
  vX.Y.Z
    - [ ] Check if the workflow was successful and check the PR opened by the
      Release bot.
- [ ] Merge PR
